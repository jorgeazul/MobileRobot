...
if("TRUE" STREQUAL "TRUE")
  set(occupancy_grid_utils_SOURCE_PREFIX /home/jorge/MobileRobot/catkin_ws/src/tools/occupancy_grid_utils)
  set(occupancy_grid_utils_DEVEL_PREFIX /home/jorge/MobileRobot/catkin_ws/devel)
  ...
  set(occupancy_grid_utils_INSTALL_PREFIX /home/jorge/MobileRobot/catkin_ws/install)
...
if(NOT "/home/jorge/MobileRobot/catkin_ws/devel/include;/home/jorge/MobileRobot/catkin_ws/src/tools/occupancy_grid_utils/include " STREQUAL " ")
  set(occupancy_grid_utils_INCLUDE_DIRS "")
  set(_include_dirs "/home/jorge/MobileRobot/catkin_ws/devel/include;/home/jorge/MobileRobot/catkin_ws/src/tools/occupancy_grid_utils/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'occupancy_grid_utils' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jservos <jservos@clearpathrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'occupancy_grid_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jorge/MobileRobot/catkin_ws/src/tools/occupancy_grid_utils/${idir}'.  Ask the maintainer 'jservos <jservos@clearpathrobotics.com>' to fix it.")
    endif()
...
set(occupancy_grid_utils_EXPORTED_TARGETS "occupancy_grid_utils_generate_messages_cpp;occupancy_grid_utils_generate_messages_lisp;occupancy_grid_utils_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${occupancy_grid_utils_dep}_FOUND)
      find_package(${occupancy_grid_utils_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${occupancy_grid_utils_dep} REQUIRED ${depend_list})
  endif()
