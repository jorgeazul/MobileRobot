...
if("TRUE" STREQUAL "TRUE")
  set(bring_up_SOURCE_PREFIX /home/jorge/MobileRobot/catkin_ws/src/bring_up)
  set(bring_up_DEVEL_PREFIX /home/jorge/MobileRobot/catkin_ws/devel)
  set(bring_up_INSTALL_PREFIX "")
  set(bring_up_PREFIX ${bring_up_DEVEL_PREFIX})
else()
  set(bring_up_SOURCE_PREFIX "")
  set(bring_up_DEVEL_PREFIX "")
  set(bring_up_INSTALL_PREFIX /home/jorge/MobileRobot/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'bring_up' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jorge <jorge@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'bring_up' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jorge/MobileRobot/catkin_ws/src/bring_up/${idir}'.  Ask the maintainer 'jorge <jorge@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${bring_up_dep}_FOUND)
      find_package(${bring_up_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${bring_up_dep} REQUIRED ${depend_list})
  endif()
